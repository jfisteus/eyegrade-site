...
BLOG_AUTHOR = "Jesús Arias Fisteus"  # (translatable)
BLOG_TITLE = "Eyegrade"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.eyegrade.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
#BASE_URL = "http://www.eyegrade.org/blog/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Blog for the free software tool Eyegrade"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/blog/categories/index.html", "Blog tags"),
...
POSTS = (
    ("posts/*.rst", "blog/posts", "post.tmpl"),
    ("posts/*.txt", "blog/posts", "post.tmpl"),
)
PAGES = (
...
#     ]
# }
DEPLOY_COMMANDS = {u'default':
    ['rsync -rav --delete output/* ../../www/git/'],
    }
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="http://www.it.uc3m.es/jaf/">{author}</a> - Powered by         <a href="http://getnikola.com" rel="nofollow">Nikola</a>         {license}'
